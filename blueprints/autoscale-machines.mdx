...
source_url: https://fly.io/docs/blueprints/autoscale-machines/
---

  <img src="/images/autoscale-machines.png" alt="Illustration by Annie Ruygt of two machines dancing and one standing still" />

## Overview

You have an app with services that's configured to [automatically start
and stop Machines based on traffic demand](/launch/autostop-autostart). But the traffic to your app changes
...
[`fly-autoscaler` app](/launch/autoscale-by-metric) in conjunction with 
[Fly Proxy autostop/autostart](/launch/autostop-autostart) to 
