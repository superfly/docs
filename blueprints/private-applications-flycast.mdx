...
One of the biggest platform features that uses Flycast out of the box is [Managed Postgres](/mpg). Even though Flycast addresses are local to your private network, Managed Postgres still configures usernames and passwords for your database.
