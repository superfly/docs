...
source_url: https://fly.io/docs/blueprints/volume-forking/
---

  <img src="/images/volume-forking.png" alt="Illustration by Annie Ruygt of a blimp and a Fly rocket flying side by side" />
...
- `fly volumes fork` [reference](/flyctl/cmd/fly_volumes_fork)
