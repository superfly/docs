...
---
  ...
  <img src="/images/using-the-fly-docker-reg.png" alt="Illustration by Annie Ruygt of Frankie the balloon and the Docker whale playing a game of bean bag toss" />
...
### To deploy a private image pushed to Fly.io's registry: {#to-deploy-a-private-image-pushed-to-fly-ios-registry}
...
Want to optimize your deploys with shared layers and pre-installed dependencies? See the [Using base images for faster deployments](/blueprints/using-base-images-for-faster-deployments#how-to-make-a-base-image) blueprint.
