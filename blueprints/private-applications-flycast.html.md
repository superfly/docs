...
Now that we’ve set up Ollama and demonstrated the platform turning it off and on for you, let’s run Llama 3. Exit the shell Machine with control-D to setup a new one with the Ollama client installed.
