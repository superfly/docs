...
source_url: https://fly.io/docs/blueprints/deno-kv-litefs/
---

import LitefsSunsetSnippet from '/snippets/docs/litefs-sunset.mdx';
...
Now, if you’re deploying to Fly.io, you’re almost ready to go. [Here’s where to look if you’re not running on Fly.io](/litefs/getting-started-docker).

## Creating a LiteFS Cloud cluster

For a more in-depth article, check out [Getting Started with LiteFS on Fly.io](/litefs/getting-started-fly).
...
This will automatically add volumes and Machines to [scale your app](/launch/scale-count#scale-an-apps-regions) out and around the world!
