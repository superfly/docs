...
source_url: https://fly.io/docs/blueprints/review-apps-guide/
---

  <img src="/images/review-apps-github.png" alt="Illustration by Annie Ruygt of Github Octocat and Frankie with some apps" />
...
Your GitHub Action will need a Fly API token to deploy and manage new review apps on Fly.io. You can get this token using the following [flyctl](/flyctl/install) command:
...
- [Continuous Deployment with Fly.io and GitHub Actions](/launch/continuous-deployment-with-github-actions) Shows how to set up automated CI/CD pipelines using GitHub Actions and Fly.io — a natural complement to per‑PR review deployments.
- [Get information about an app](/apps/info) A handy guide to inspecting apps, machines, statuses via CLI/API — useful when you’re creating and destroying review apps on pull requests.
