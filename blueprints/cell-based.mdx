...
source_url: https://fly.io/docs/blueprints/cell-based/
---
...
[fly-replay](/networking/dynamic-request-routing#the-fly-replay-response-header)
response header.
...
Note that [fly machine clone](/flyctl/cmd/fly_machine_clone) has a
 ...
 * [LiteFS](/litefs) - Distributed SQLite.  By itself, it
   supports failover situations naturally.  Additional [disaster
   recovery](/litefs/backup) options are available.
