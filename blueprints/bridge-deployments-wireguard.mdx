...
source_url: https://fly.io/docs/blueprints/bridge-deployments-wireguard/
---

  <img src="/images/bridge-deployment.png" alt="Illustration by Annie Ruygt of a figure with wings and a ship some balloons and planes" />

## Overview

Sometimes you can recreate production on Fly.io without any issues. Other times you need to be able to incrementally move things over. Fly.io [has private networking](/networking/private-networking) by default for apps in the same organization, but you can also easily connect your existing external servers to this private network. This lets you use your private network as a way to incrementally move services over.
...
- The region you want to create the peer in: you should choose [the closest region to the target computer](/reference/regions).
...
This means that you can successfully query any [`.internal` addresses](/networking/private-networking#fly-io-internal-dns) for apps and Machines in your organization. Congrats, you're in!
...
- [Jack into your private network with WireGuard](/blueprints/connect-private-network-wireguard) A guide showing how to connect a laptop or external server to your Fly.io private network via WireGuard.  
- [Private Networking](/networking/private-networking) Overview of Fly’s internal IPv6 mesh (6PN), how apps talk to each other privately, and how WireGuard‑based tunnels integrate.  
- [Custom Private Networks](/networking/custom-private-networks) How to isolate tenants, apps, or services by creating separate private networks inside your organization — relevant when bridging external infrastructure.
