...
- **Data tier** → [Fly Managed Postgres](/mpg) (our hosted Postgres that handles the messy parts for you)
...
- **Let the database do its job**: With [Managed Postgres](/mpg), you don’t need to worry about setup, backups, or failover.
...
Now create your **data tier** with [Fly Managed Postgres](/mpg):
...
More details on creating and connecting a managed Postgres database can be found [here](/mpg/create-and-connect).
...
- **Data tier**: [Fly Managed Postgres](/mpg)
...
- Explore the features of [Fly Managed Postgres](/mpg) 
