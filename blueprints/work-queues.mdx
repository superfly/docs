...
source_url: https://fly.io/docs/blueprints/work-queues/
---

  <img src="/images/work-queue.png" alt="Illustration by Annie Ruygt of a robot setting up a queue of boxes and tasks" />
