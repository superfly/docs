---
title: fly doctor diag
source_url: https://fly.io/docs/flyctl/doctor-diag/
---
...
* [fly doctor](/flyctl/cmd/fly_doctor)	 - The DOCTOR command allows you to debug your Fly environment
