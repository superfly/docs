...
<a class="flex ai:center leading:lg" href="#macos">
  <svg fill="currentColor" class="relative top:-2p mr:8p" width="21" height="21" viewBox="0 0 24 24">
    <path d="M22 17.607c-.786 2.28-3.139 6.317-5.563 6.361-1.608.031-2.125-.953-3.963-.953-1.837 0-2.412.923-3.932.983-2.572.099-6.542-5.827-6.542-10.995 0-4.747 3.308-7.1 6.198-7.143 1.55-.028 3.014 1.045 3.959 1.045.949 0 2.727-1.29 4.596-1.101.782.033 2.979.315 4.389 2.377-3.741 2.442-3.158 7.549.858 9.426zm-5.222-17.607c-2.826.114-5.132 3.079-4.81 5.531 2.612.203 5.118-2.725 4.81-5.531z" />
  </svg>
  macOS
</a>
<a class="flex ai:center leading:lg" href="#64-bit-linux">
  <svg fill="currentColor" class="relative top:-1p mr:8p" width="22" height="22" viewBox="0 0 24 24">
...
<a class="flex ai:center leading:lg pl:4p" href="#windows">
  <svg fill="currentColor" class="relative top:-1p mr:8p" width="16" height="16" viewBox="0 0 24 24">
...
If you have the [Homebrew](https://brew.sh) package manager installed, flyctl can be installed in /usr/local (or wherever Brew is configured to keep installed applications) by running:
...
Set the environment variable FLYCTL\_INSTALL to set the directory for flyctl to be installed in and it will be installed a bin directory of the FLYCTL\_INSTALL directory. For example, if you want to install flyctl in /usr/local/bin, use:

```cmd
curl -L https://fly.io/install.sh | FLYCTL_INSTALL=/usr/local sh
```
## _Arch Linux_
`flyctl-bin` is available in the [Arch User Repository](https://aur.archlinux.org/packages/flyctl-bin/). You can install it with `pacman -S flyctl-bin`.
