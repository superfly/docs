---
title: Health Checks
source_url: https://fly.io/docs/reference/health-checks/
---

  <img src="/images/health-checks.png" alt="Illustration by Annie Ruygt of a balloon doctor examining a machine" />
...
For more information on custom checks, check out the [checks section](/reference/configuration#the-checks-section).
...
Service-level checks are configured using the [`[[services.tcp_checks]]`](/reference/configuration#services-tcp_checks), [`[[services.http_checks]]`](/reference/configuration#services-http_checks) and [`[[http_service.checks]]`](/reference/configuration#http_service-checks) sections.
...
Machine checks are configured using the [`[[services.machine_checks]]`](/reference/configuration#services-machine_checks) and [`[[http_service.machine_checks]]`](/reference/configuration#the-http_service-machine_checks-section) sections.
...
- [Seamless/Zero-downtime deployments](/blueprints/seamless-deployments)
