...
Check the docs for more information: [High Availability and Global Replication](/postgres/advanced-guides/high-availability-and-global-replication)

Looking for more? See how to:

* [Connect to Fly Postgres](/postgres/connecting)
* [Attach your app](/postgres/managing/attach-detach)
* [Monitor your Postgres cluster](/postgres/managing/monitoring)
