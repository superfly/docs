...
source_url: https://fly.io/docs/reference/postgres-whats-next/
noindex: true
---
...
Check the docs for more information: [High Availability and Global Replication](/unmanaged-postgres/advanced-guides/high-availability-and-global-replication)

Looking for more? See how to:

* [Connect to Fly Postgres](/unmanaged-postgres/connecting)
* [Attach your app](/unmanaged-postgres/managing/attach-detach)
* [Monitor your Postgres cluster](/unmanaged-postgres/managing/monitoring)
