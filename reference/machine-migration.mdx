...
### 3. Fork the Machine's volume {#3-fork-the-machines-volume}
...
The 6PN address will be different from the original machine. Most apps communicating on Fly.io private networks use [our internal DNS](/networking/private-networking#fly-io-internal-dns) to query for 6PN addresses and that feature will continue to work as usual. Note that apps should never rely on 6PN addresses remaining static.
