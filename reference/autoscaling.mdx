---
title: Autoscaling
source_url: https://fly.io/docs/reference/autoscaling/
---

  <img src="/images/autoscaling.png" alt="Illustration by Annie Ruygt of several machines running" />
...
## Autostop/autostart Machines {#autostop-autostart-machines}
...
For details about how it works, see [Fly Proxy autostop/autostart](/launch/autostop-autostart). To configure autostop/autostart for your app, see [Autostop/autostart Machines](/launch/autostop-autostart).
...
To learn how to deploy and configure the autoscaler, see [Autoscale based on metrics](/launch/autoscale-by-metric).
