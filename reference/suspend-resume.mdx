...
source_url: https://fly.io/docs/reference/suspend-resume/
---
...
- **No** [**swap**](/reference/configuration#swap_size_mb-option) **configured**
- **No** [**schedule**](/machines/flyctl/fly-machine-run#start-a-machine-on-a-schedule) **configured** 
...
Suspend automatically saves a machine's memory state to persistent storage. You don't need to attach a [volume](/volumes) for suspend to work, and the snapshot isn't stored on a volume.
...
If a suspended machine has a volume, you continue paying for the volume for as long as it exists [Volume storage](/about/pricing#persistent-storage-volumes) is billed whether the machine is running, stopped, or suspended.
...
## Monitoring & Debugging {#monitoring-amp-debugging}
...
- [Autostop & Autostart](/launch/autostop-autostart)
- [Fly Proxy Config](/reference/fly-proxy-autostop-autostart)
- [Scaling Machines](/launch/scale-count)
