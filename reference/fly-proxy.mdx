---
title: Fly Proxy
source_url: https://fly.io/docs/reference/fly-proxy/
---
...
Apps can communicate with each other by default on your [private network](/networking/private-networking) without Fly Proxy's help, but if you want to use Fly Proxy features, then you can do that with [Flycast](/networking/flycast).
...
For more information and an example describing how Fly Proxy balances load, see [Load balancing](/reference/load-balancing).
...
Learn more about [how autostop/autostart works](/reference/fly-proxy-autostop-autostart) and [how to configure it](/apps/autostop-autostart).
...
Learn more about [dynamic request routing](/networking/dynamic-request-routing).
