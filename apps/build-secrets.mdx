---
title: Build Secrets
source_url: https://fly.io/docs/apps/build-secrets/
---

You can set [secrets](/apps/secrets) for your applications, but these are only available at _run-time_. They aren't available when building your Docker image without a little extra work.
