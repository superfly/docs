...
source_url: https://fly.io/docs/apps/info/
---

  <img src="/images/docs-books.webp" alt="" />
...
### Show a Machine's configuration {#show-a-machines-configuration}
...
## Watch an app's logs {#watch-an-apps-logs}
