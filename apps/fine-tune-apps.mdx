...
source_url: https://fly.io/docs/apps/fine-tune-apps/
---
...
We have various ways to access metrics for Fly Proxy, your app, and Fly Machines. Learn more about [Fly Metrics](/monitoring/metrics).
...
Check which [Fly.io region](/reference/regions) you're reaching.
...
If your app has multiple threads, make sure that contention isn't an issue. You can also [scale CPU resources](/launch/scale-machine) as needed.
...
Right-size Machines to use more parallel processing. Learn more about [Machine sizing](/machines/guides-examples/machine-sizing#general-rules).

### Concurrency settings for connections or requests

Refer to our guidelines for [concurrency settings](/apps/concurrency).

### Auto stop and start feature

[Auto stop and start](/launch/autostop-autostart) can be turned off if you want to test the performance of your app without that variable.
