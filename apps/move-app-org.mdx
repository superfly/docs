...
source_url: https://fly.io/docs/apps/move-app-org/
---
...
Go to the App Settings page in your Dashboard, click Move app, pick the new organization, and wait for the deployment to finish. Your app will be up and running once the transfer is complete.
  ...
  <img src="/images/move-app-ui-sm.png" alt="App settings page with Move app option" />
...
- **[Upstash for Redis](/upstash/redis):** Upstash Redis is only available over an organization's private network. After you move the app, you'll need to provision a new database for the new org.
- **[Tigris object storage](/tigris):** Before moving the app, you'll need to delete the bucket, then recreate it in the new org and set the new secrets. Billing for the new bucket will be tied to the new org.

## Read more

[App handover guide: considerations and approaches](/apps/app-handover-guide)
