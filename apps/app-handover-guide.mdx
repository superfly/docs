...
source_url: https://fly.io/docs/apps/app-handover-guide/
---

  <img src="/images/app-handover-guide.png" alt="Illustration by Annie Ruygt of a house with a Welcome sign and hot air balloons in the backgroud" />
...
### Option 1: Build in the customer’s org from day one {#option-1-build-in-the-customers-org-from-day-one}
...
- [Move an app between orgs](/apps/move-app-org)

- [Fly.io billing](/about/billing)
