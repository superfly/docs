...
Smokescreen runs on port 4750 and applications wishing to connect to it from within your Fly organization should send their requests to `yourappname.internal`. To connect to Smokescreen from outside the Fly environment, use [Fly's WireGuard](/blueprints/connect-private-network-wireguard) to create a VPN into your Fly organization. 
