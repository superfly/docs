...
source_url: https://fly.io/docs/app-guides/graphql-on-fly-with-hasura/
---
...
**If you don't have `flyctl`, you'll need to install it. Check out our [Install Flyctl](/flyctl/install) guide. If you haven't got a Fly account yet, run `flyctl auth signup` to get your own free account.**
