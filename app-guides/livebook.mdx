...
source_url: https://fly.io/docs/app-guides/livebook/
---

In this guide we'll deploy [Livebook](https://livebook.dev), the interactive Elixir notebook app, to a single Fly Machine using the [Fly Launch](/launch/index) approach. 

We'll give Livebook a 1GB [persistent volume](/volumes) on which to store notebooks and other data.
