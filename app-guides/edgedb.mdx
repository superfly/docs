---
title: EdgeDB on Fly
source_url: https://fly.io/docs/app-guides/edgedb/
---
...
If you've [configured a Wireguard tunnel](/networking/private-networking) on your local machine, you'll be able to open a REPL to your new EdgeDB instance with the `edgedb` CLI.
