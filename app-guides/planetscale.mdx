...
source_url: https://fly.io/docs/app-guides/planetscale/
---
...
![Screenshot](/images/planetscale_new_database_dialog.webp)
...
![Screenshot](/images/planetscale_database_created.webp)
...
![Screenshot](/images/planetscale_connect_nodejs.webp)
...
![Screenshot](/images/planetscale_arctype_connections.webp)
...
![Screenshot](/images/planetscale_arctype_connection_url.webp)
...
![Screenshot](/images/planetscale_arctype_new_query.webp)
...
![Screenshot](/images/planetscale_arctype_create_table_succeeded.webp)
...
![Screenshot](/images/planetscale_promote.webp)
...
![Screenshot](/images/planetscale_add_region.webp)

Choose the region you would like to create it in:

![Screenshot](/images/planetscale_add_region_dialog.webp)
...
![Screenshot](/images/planetscale_add_region_connect.webp)
...
If you haven't already done so, [install the Fly CLI](/flyctl/install) and  then [log in to Fly](/getting-started/sign-up-sign-in).
...
![Screenshot](/images/planetscale_misc_statistics.webp)
...
![Screenshot](/images/planetscale_misc_delete.webp)
