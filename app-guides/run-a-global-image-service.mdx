...
source_url: https://fly.io/docs/app-guides/run-a-global-image-service/
---

import ObsoleteDocSnippet from '/snippets/obsolete-doc.mdx';

  <img src="/images/image-service.webp" alt="A hand holding scissors and cutting out paper for a scrapbook" />
...
If you've already installed `flyctl`, move on to the next step. If not, hop over to [our installation guide](/flyctl/install).
