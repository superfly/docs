...
og:description: At some point a Laravel application will need to run additional services, perhaps
  Redis for a cache or session storage. Learn how to manage multiple applications
  from one Laravel project to keep your monolith a monolith.
source_url: https://fly.io/docs/laravel/advanced-guides/multiple-applications/
---
