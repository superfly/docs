---
title: Using Symfony
og:description: See how to run Symfony apps, with just a few tweaks to the Laravel configuration.
source_url: https://fly.io/docs/laravel/advanced-guides/using-symfony/
---
