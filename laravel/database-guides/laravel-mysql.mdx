...
og:description: Notes and configurations on connecting with the relational database classic, [MySQL](https://www.mysql.com/)
source_url: https://fly.io/docs/laravel/database-guides/laravel-mysql/
---
...
![PlanetScale initialize database dashboard](/images/planetscale_laravel_new_database.webp)
<ol>
...
![PlanetScale Laravel connection string](/images/planetscale_laravel_connection_string.webp)
