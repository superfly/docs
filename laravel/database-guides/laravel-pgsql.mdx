...
We have a _[whole section](/postgres)_ dedicated to [PostgreSQL](https://www.postgresql.org/), we even have a `flyctl` integration to simplify both creation and interaction with your Postgres Fly Apps! 

## _Laravel and PostgreSQL Fly App_

To run PostgreSQL as a [Fly App](/app-guides/mysql-on-fly), follow our guide [here](/postgres/getting-started/create-pg-cluster). Afterwards you can connect it with your Laravel Fly App through various means:
...
1.  You can [Attach your Laravel Fly App to your Postgres Fly App](/postgres/managing/attach-detach) with `fly postgres attach`:
...
1. You can check out various ways to connect with your Postgres Fly App from your local environment, [here](/postgres/connecting/connecting-with-flyctl).
