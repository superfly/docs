...
og:description: Notes and configurations on connecting with the object-relational database system,
  [PostgreSQL](https://www.postgresql.org/)
source_url: https://fly.io/docs/laravel/database-guides/laravel-pgsql/
---

import {Small} from "/snippets/Small.jsx";

We have a _[whole section](/unmanaged-postgres)_ dedicated to [PostgreSQL](https://www.postgresql.org/), we even have a `flyctl` integration to simplify both creation and interaction with your Postgres Fly Apps! 

## _Laravel and PostgreSQL Fly App_

To run PostgreSQL as a [Fly App](/app-guides/mysql-on-fly), follow our guide [here](/unmanaged-postgres/getting-started/create-pg-cluster). Afterwards you can connect it with your Laravel Fly App through various means:
...
1.  You can [Attach your Laravel Fly App to your Postgres Fly App](/unmanaged-postgres/managing/attach-detach) with `fly postgres attach`:
...
If you decide not to use the `fly postgres attach` command above and would want to connect to your Laravel Fly App in a manual, _grueling_ step-by-step procedure, I hear you! You'll have to:
...
Once you have your running and _[database configured](/laravel/database-guides/laravel-pgsql#manually-set-up-a-database-in-your-postgres-fly-app)_ Postgres Fly App, it's time to connect with your Laravel Fly App:
...
3.  You've _finally_ reached the last part. You can now rest easy and deploy:
...
1. You can check out various ways to connect with your Postgres Fly App from your local environment, [here](/unmanaged-postgres/connecting/connecting-with-flyctl).
...
1.  First up, check your php.ini file and make sure the driver for Postgres is available and _uncommented_:
