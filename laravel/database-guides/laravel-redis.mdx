...
og:description: Notes and configurations on connecting with the "in-memory data store", [Redis](https://redis.io/)
source_url: https://fly.io/docs/laravel/database-guides/laravel-redis/
---
...
1.  Follow the steps [above](/laravel/the-basics/databases#setup-using-the-fly-io-redis-docker-image), with a revision to the value passed for `--image`
