...
Extensions like [Postgres](/mpg/index) ( database ), [Redis](/upstash/redis) ( cache ), and [Tigris](/tigris#main-content-start) ( storage ) can also be added by default based on whether there's an existing, similar connection found for your Laravel project. 
