...
source_url: https://fly.io/docs/laravel/
---

import FlyctlSnippet from '/snippets/languages-and-frameworks/flyctl.mdx';
import LaunchedSnippet from '/snippets/languages-and-frameworks/launched.mdx';

  <img src="/images/laravel-intro.webp" alt=""/>
...
Extensions like [Postgres](/postgres/index) ( database ), [Redis](/upstash/redis) ( cache ), and [Tigris](/tigris#main-content-start) ( storage ) can also be added by default based on whether there's an existing, similar connection found for your Laravel project. 
...
For sensitive data, you can set **secrets** with the [`fly secrets set`](/flyctl/cmd/fly_secrets_set) command:
