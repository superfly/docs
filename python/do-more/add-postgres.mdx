---
title: Add Postgres
og:description: How to setup and connect to a postgres database.
source_url: https://fly.io/docs/python/do-more/add-postgres/
---
...
<Warning>
Warning: Fly Postgres is not managed postgres. Read what that means [here](/postgres/getting-started/what-you-should-know).
</Warning>
...
- [psycopg2](https://www.psycopg.org/docs/) / [psycopg3](https://www.psycopg.org/psycopg3/)
...
You can check out [this gist](https://gist.github.com/fliepeltje/5a2b63d4b1169f5cb200a665cee3f926) for the complete example app.
