...
og:description: FastAPI is a modern, fast (high-performance), web framework for building APIs with
  Python based on standard Python type hints.
source_url: https://fly.io/docs/python/frameworks/fastapi/
---
...
In this guide we’ll learn how to deploy a [FastAPI](https://fastapi.tiangolo.com/) application on Fly.io.
