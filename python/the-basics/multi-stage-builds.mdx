...
og:description: A strategy to make your containers smaller in size and reduce attack surface.
source_url: https://fly.io/docs/python/the-basics/multi-stage-builds/
---
