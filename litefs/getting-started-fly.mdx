...
source_url: https://fly.io/docs/litefs/getting-started-fly/
---
...
[fly.io]: https://fly.io
[lease management]: /litefs/config#lease-management
...
[proxy configuration guide]: /litefs/proxy
...
Refer to the [`litefs import`](/litefs/import) documentation for more details.
