...
sidebarTitle: Using Cloud for Backups
source_url: https://fly.io/docs/litefs/cloud-backups/
---
...
[getting started guide](/litefs/getting-started-fly), which walks you
...
[Backing up your LiteFS cluster](/litefs/backup) docs.
...
[sign up for an account](/getting-started/sign-up-sign-in) if you haven't already. After you're signed in,
...
[installing the latest version](/litefs/getting-started-fly#installing-litefs).
