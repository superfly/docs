...
sidebarTitle: Reading the event stream
source_url: https://fly.io/docs/litefs/events/
---

LiteFS provides mechanisms for reading the [replication position](/litefs/position) and
[current primary status](/litefs/primary) through the FUSE file system mount. However,
...
two fields form the [replication position](/litefs/position).
