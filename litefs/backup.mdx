...
sidebarTitle: Backing up your cluster
source_url: https://fly.io/docs/litefs/backup/
---
...
export](/litefs/export) command and then upload that file to long-term
...
SQLite database to a file and then use [litefs import](/litefs/import) to 
