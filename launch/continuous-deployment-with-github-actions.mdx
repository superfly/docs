...
source_url: https://fly.io/docs/launch/continuous-deployment-with-github-actions/
---

<img src="/images/continuous-deployment.webp" alt="A man writing code on a vintage desktop computer" className="rounded-xl"/>

This guide works through setting up your app for continuous deployment to Fly.io from the app's GitHub repository. You might also like our blueprint on [deploying review apps with GitHub Actions](/blueprints/review-apps-guide).
...
9. Commit your changes and push them up to GitHub. You should be pushing two new files: `fly.toml`, the [Fly Launch](/launch/index) configuration file, and `fly.yml`, the GitHub action file.
...
* [Blueprint: Deploy review apps with GitHub Actions](/blueprints/review-apps-guide)
* [Deploy Tokens](/security/tokens)
