...
source_url: https://fly.io/docs/deep-dive/
---

  <img src="/images/deep-dive.png" alt="Illustration by Annie Ruygt of a bird in a diver costume, swimming under water" />
...
If you came from our [Speedrun](https://fly.io/speedrun) or [Getting started](/getting-started) pages, maybe you want to go beyond `hello world` and explore the platform so you can feel confident that you're choosing a provider that can support you now, and scale with you later on as you grow.
...
Fly.io minimizes surprises by taking a lot of work off your plate with our [Public Network Services](/networking/services), [Fly Proxy routing](/reference/fly-proxy), out-of-the-box [Private Networking](/networking/private-networking), and preconfigured databases.
...
The deep dive demo is based on [MDN's Web Dictaphone](https://github.com/mdn/dom-examples/tree/main/media/web-dictaphone).
You can play with a [live demo hosted on GitHub](https://mdn.github.io/dom-examples/media/web-dictaphone/). The Web Dictaphone app is about as basic of an HTML form as you can get, and it has the added bonus of providing the ability to generate as many media files as you want using only your voice.
...
* [Upstash for Redis](/upstash/redis) and [WebSockets](https://developer.mozilla.org/en-US/docs/Web/API/WebSockets_API) to handle the connections for the realtime requirement

### Available runtimes

Our deep dive demo comes in five flavors (so far):

  * [Django](/deep-dive/django)
  * [Next.js](/deep-dive/nextjs)
  * [Node.js](/deep-dive/nodejs)
  * [Phoenix](/deep-dive/phoenix)
  * [Rails](/deep-dive/rails)
