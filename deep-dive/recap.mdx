---
title: Recap
source_url: https://fly.io/docs/deep-dive/recap/
---
...
Fly.io can support your apps now, with flexible built-in features, and scale with you later as you grow, with low-level control of Machines and powerful compute in 35 [regions](/reference/regions).
...
## Learn more
  ...
  * [Application Monitoring by Sentry](/monitoring/sentry)
  * [Application Security by Arcjet](/security/arcjet)
