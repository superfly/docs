...
source_url: https://fly.io/docs/deep-dive/launch-deep-dive/
---
...
**Step 1:** [Install flyctl](/flyctl/install).
...
Once you're back and/or rested up, explore the app and add-on components. Feel free to review the following in any order, or chose to skip ahead:
  ...
  * [Your Fly App](/deep-dive/application)
  * [PostgreSQL database](/deep-dive/postgresql)
  * [Tigris Object Storage](/deep-dive/tigris)
  * [Upstash Redis](/deep-dive/redis)
