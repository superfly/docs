...
source_url: https://fly.io/docs/mpg/guides-examples/phoenix-guide/
---

  <img src="/images/phoenix.png" alt="Illustration by Annie Ruygt of a Phoenix bird resting with Frankie the balloon looking on" />

For general connection configuration that applies to all languages — connection lifetime, idle timeouts, proxy restart behavior, and troubleshooting — see [Connect Your Client](/postgres/client-configuration).
...
### 3. Legacy fallback (Oban < 2.14) {#3-legacy-fallback-oban-lt-2-14}
...
- `non-existing domain - :nxdomain` - Make sure [ipv6 is enabled](/elixir/getting-started#important-ipv6-settings)
