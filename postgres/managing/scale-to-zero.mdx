...
If you select the Development configuration when you [create your Fly Postgres app](/postgres/getting-started/create-pg-cluster), then you also get the option to have your database scale down to zero after one hour.
