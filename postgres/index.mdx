...
**[Read about why Fly Postgres is not the same thing as a managed database service](/postgres/getting-started/what-you-should-know).**
...
You can also add read-only replicas in other regions and take advantage of the Fly.io platform's proxy features to build a [Globally Distributed Postgres cluster](/postgres/advanced-guides/high-availability-and-global-replication).
