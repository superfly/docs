...
As the requirements for your Postgres deployment becomes more demanding, like the need for [High Availability and Global Replication](/docs/postgres/advanced-guides/high-availability-and-global-replication), checkout the [advanced guides](/docs/postgres/advanced-guides).
