...
source_url: https://fly.io/docs/upstash/vector/
---
...
Creating and managing indexes happens exclusively via the [Fly CLI](/flyctl/install). Install it, then [signup for a Fly account](/getting-started/sign-up-sign-in).
...
Your index is accessible only via a [private IPv6 address](/networking/flycast) restricted to your Fly.io organization's network.
