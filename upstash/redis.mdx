---
title: "Upstash for Redis\xAE*"
source_url: https://fly.io/docs/upstash/redis/
---
...
Creating and managing databases happens exclusively via the [Fly CLI](/flyctl/install). Install it, then [signup for a Fly account](/getting-started/sign-up-sign-in).
...
Upstash Redis is available in all Fly regions via a [private IPv6 address](/networking/flycast) restricted to your Fly organization. Traffic is automatically routed to the nearest replica, or in the absence of nearby replicas, to the primary instance.
...
#### Prod Pack - \$200/mo {#prod-pack-200-mo}
