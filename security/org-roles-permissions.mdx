...
source_url: https://fly.io/docs/security/org-roles-permissions/
---
...
Fly.io organizations are free to create, and there's no technical limit to how many you can have. One thing to note, each organization needs a payment method or a linked billing organization.  You can read more about linked organizations and billing [here](/about/billing#unified-billing).
...
- [Moving an application between orgs](/apps/move-app-org)
- [Handing over an application](/apps/app-handover-guide)
- [Read-only tokens reference](/flyctl/cmd/fly_tokens_create_readonly)
