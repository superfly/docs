...
source_url: https://fly.io/docs/security/sso/
---
...
Install the [Fly.io GitHub app](https://fly.io/app/auth/github_app) on the GitHub organization you want to use for SSO.
...
- [Use organizations for staging and production isolation](/blueprints/staging-prod-isolation)
