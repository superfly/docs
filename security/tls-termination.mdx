...
source_url: https://fly.io/docs/security/tls-termination/
---
...
To set up certificates for a custom domain, including importing your own certificates, see [Custom domains](/networking/custom-domain).

You can [configure a specific TLS version and ALPN protocols](/reference/configuration#services-ports-tls_options) for your app in the `fly.toml` config file.

For supported versions and cipher suites, see [TLS support](/networking/tls).
