...
After [creating your MPG cluster](/mpg/create-and-connect) and attaching your app, these are the essentials:
...
See the [Phoenix guide](/mpg/guides-examples/phoenix-guide) for Elixir-specific migration setup.
...
All MPG clusters include PgBouncer for connection pooling. The pool mode you choose on the cluster side affects what your client can do. See [Cluster Configuration](/mpg/cluster-configuration) for how to change modes.
...
- **`LISTEN/NOTIFY`** doesn't work — use an alternative notifier (see the [Phoenix guide](/mpg/guides-examples/phoenix-guide) for Oban examples)
...
For comprehensive Phoenix setup including migrations, Oban configuration, and Ecto-specific troubleshooting, see the [Phoenix with Managed Postgres](/mpg/guides-examples/phoenix-guide) guide.
