...
By default the `plpgsql`, `pg_stat_monitor`, and `pgaudit` extensions are enabled and cannot be disabled. Other trusted extensions can be enabled from the Extensions tab for your MPG cluster.
