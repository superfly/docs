---
title: 1. Install flyctl
layout: navigable_docs
order: 1
objective: Install the `flyctl` command line tool that you'll use to create and sign-in to your Fly.io account so you can launch and manage your apps.
redirect_from: 
