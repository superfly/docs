...
source_url: https://fly.io/docs/getting-started/migrate-from-heroku/
---

  <img src="/images/migrate.png" alt="Illustration by Annie Ruygt of a bird carrying an app to a balloon who is welcoming the app to join his group" />
...
## TL;DR - The Fast Path {#tl-dr-the-fast-path}
...
## Step 7: Configure Processes (Web + Workers) {#step-7-configure-processes-web-workers}
...
## Multiple Environments (Staging/Production) {#multiple-environments-staging-production}
...
For CI/CD, use GitHub Actions with the [Fly GitHub Action](/launch/continuous-deployment-with-github-actions).
