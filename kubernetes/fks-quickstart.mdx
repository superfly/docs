...
source_url: https://fly.io/docs/kubernetes/fks-quickstart/
---

  <img src="/images/kubernetes.png" alt="Illustration by Annie Ruygt of a figure sailing a ship with a balloon overhead" />
