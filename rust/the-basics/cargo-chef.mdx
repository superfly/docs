---
title: Cargo Chef
og:description: Cargo Chef is a cargo extension that is commonly used in Dockerfiles for Rust apps.
source_url: https://fly.io/docs/rust/the-basics/cargo-chef/
---
