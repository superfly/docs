...
source_url: https://fly.io/docs/rails/cookbooks/databases/
---
...
<div className="absolute top-0 left-0 h-screen w-screen mx-auto mb-3 bg-navy px-20 py-14 rounded-[20vh] flex flex-row items-center justify-center" style="background-color:rgb(36 24 91)">
  <img src="https://fly.io/static/images/brand/brandmark-light.svg" className="h-[50vh]" style="margin-top: -15px" alt="The monochrome white Fly.io brandmark on a navy background" srcset="">

  <div className="text-white" style="font-size: 40vh; padding: 10vh" data-controller="counter">
...
[Upstash for Redis](/upstash/redis), and creating
...
[This Is Not Managed Postgres ](/postgres/getting-started/what-you-should-know).  That information may be useful in the future so
...
[MySQL on Fly](/app-guides/mysql-on-fly)
 ...
 * [sqlite3](/rails/cookbooks/databases/Dockerfile1)
 * [postgres](/rails/cookbooks/databases/Dockerfile2)
 * [mysql](/rails/cookbooks/databases/Dockerfile3)
