---
title: Copy source
source_url: https://fly.io/docs/rails/cookbooks/sources/
---
...
A few example Dockerfiles that you can download to demonstrate these concepts:
  * [minimal/import maps](/rails/cookbooks/sources/Dockerfile1)
  * [esbuild/volta](/rails/cookbooks/sources/Dockerfile2)
  * [api](/rails/cookbooks/sources/Dockerfile3)
