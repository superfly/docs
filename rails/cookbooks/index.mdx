---
title: Cookbooks
source_url: https://fly.io/docs/rails/cookbooks/
---
...
For best results, you are encouraged to try out each step.  To do so, you will need to [Log in to Fly](/getting-started/sign-up-sign-in).  Nothing you do in this tutorial will exceed the [Free Allowances](/about/pricing#free-allowances) provided.
