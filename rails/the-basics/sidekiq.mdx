...
og:description: Deploy Rails applications that run in multiple processes to one Fly application, like
  Sidekiq background jobs.
source_url: https://fly.io/docs/rails/the-basics/sidekiq/
---
