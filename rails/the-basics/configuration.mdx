...
og:description: Add environment variables to your Rails applications, configure secrets, and use the
  encrypted `credentials.yml` file to manage your application's configuration on Fly.
source_url: https://fly.io/docs/rails/the-basics/configuration/
---
