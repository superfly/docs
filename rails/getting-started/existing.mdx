...
og:description: Learn how to run your existing Rails applications on Fly.
source_url: https://fly.io/docs/rails/getting-started/existing/
---
...
create`](/unmanaged-postgres/getting-started/create-pg-cluster).
...
<code>[fly postgres attach](/unmanaged-postgres/managing/attach-detach)</code>.
