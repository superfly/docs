...
og:description: Quickly get a very basic Rails app up and running on Fly.io. This guide is the fastest
  way to try using Fly, so if you're short on time start here.
source_url: https://fly.io/docs/rails/getting-started/
---
