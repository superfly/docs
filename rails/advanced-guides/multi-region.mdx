...
og:description: Architect Rails applications so they can run closer to your customers on servers deployed
  around the world.
source_url: https://fly.io/docs/rails/advanced-guides/multi-region/
---
