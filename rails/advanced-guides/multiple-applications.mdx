...
og:description: At some point a Rails application will need to run additional services, like a Puppeteer
  server that takes screenshots of a webpage for your Rails application. Learn how
  to manage multiple applications from one Rails project to keep your monolith a monolith.
source_url: https://fly.io/docs/rails/advanced-guides/multiple-applications/
---
