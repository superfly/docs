...
og:description: This guide shows you how to replace the Puma web server with nginx and Phusion Passenger.
source_url: https://fly.io/docs/rails/advanced-guides/phusion-passenger/
---
