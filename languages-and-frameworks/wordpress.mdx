...
source_url: https://fly.io/docs/languages-and-frameworks/wordpress/
---
...
## Configure & deploy the WordPress application {#configure-amp-deploy-the-wordpress-application}
