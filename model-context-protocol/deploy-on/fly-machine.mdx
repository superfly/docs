---
title: A Fly Machine
og:description: Demonstrates using flyctl launch to create a Fly.io machine that runs an MCP server
  remotely.
source_url: https://fly.io/docs/mcp/deploy-on/fly-machine/
---

[Fly Machines](/machines) are fast-launching VMs; they can be started and stopped at subsecond speeds. We give you control of your Machine count and each Machine’s lifecycle, resources, and region placement with a simple REST API or flyctl commands.
