---
title: Examples
source_url: https://fly.io/docs/mcp/examples/
---
...
We provide a [flyctl MCP server](/model-context-protocol/flyctl-server) for issuing flyctl commands:
...
[mcp-internal-dns](https://github.com/fly-apps/mcp-internal-dns?tab=readme-ov-file#overview) enables your MCP client to query [Fly.io `.internal` DNS](/networking/private-networking#fly-io-internal-dns):
