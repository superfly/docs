---
title: stdio
og:description: This guide shows you how to wrap and proxy a stdio MCP server so that it can be deployed
  remotely.
source_url: https://fly.io/docs/mcp/transports/stdio/
---
...
![MCP Proxy/Wrapper data flow](/images/mcp-proxy-wrap-flog.png)
