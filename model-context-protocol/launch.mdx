...
source_url: https://fly.io/docs/mcp/launch/
---
...
See [Examples](/model-context-protocol/examples) for a number of examples.

See the [`fly mcp launch` documentation](/flyctl/cmd/fly_mcp_launch) for more details on the command and its options.
