...
source_url: https://fly.io/docs/postgres/getting-started/migrate-from-heroku/
noindex: true
---
...
Read through [the documentation on connecting to your Postgres instances](/unmanaged-postgres/connecting) to start accessing your data.
