---
title: Monitor a Postgres App
og:description: Check on the health of your cluster, view logs, see which metrics are available for
  export.
source_url: https://fly.io/docs/postgres/managing/monitoring/
---
