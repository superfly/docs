---
title: Postgres Configuration Tuning
og:description: Learn how to tune your Postgres database to your needs.
source_url: https://fly.io/docs/postgres/managing/configuration-tuning/
noindex: true
---
...
View your cluster's current configurable settings with [`fly postgres config show`](/flyctl/cmd/fly_postgres_config_show):
...
To demo how this works we'll update the `max-connections` setting from 300 to 500 using [`fly postgres config update`](/flyctl/cmd/fly_postgres_config_update). 
