...
og:description: Learn about the scale to zero after one hour feature, and how to remove it, for your
  Postgres Development project.
source_url: https://fly.io/docs/postgres/managing/scale-to-zero/
noindex: true
---
...
If you select the Development configuration when you [create your Fly Postgres app](/unmanaged-postgres/getting-started/create-pg-cluster), then you also get the option to have your database scale down to zero after one hour.
