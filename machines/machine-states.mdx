...
source_url: https://fly.io/docs/machines/machine-states/
---
...
![Machine state lifecycle diagram](/images/mermaid-diagram-1.png)

### Machine version state transitions

![Machine version state transitions diagram](/images/mermaid-diagram-2.png)
...
- [Machines API reference](/machines/api)
- [Working with Machines](/machines)
- [Fly machine update command](/machines/flyctl/fly-machine-update)
