...
* **Other languages:** generate a client from the [OpenAPI spec](https://docs.fly.io/api/machines/openapi.json) with a tool like [openapi-generator](https://openapi-generator.tech/).
