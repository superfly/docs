...
source_url: https://fly.io/docs/machines/cpu-performance/
---
...
We publish a number of [Instance Load and CPU](/monitoring/metrics#instance-load-and-cpu) platform metrics you can use to monitor quota and throttling behavior of your Machines. The easiest way to visualize these metrics is on the [CPU Quota Balance and Throttling](https://fly-metrics.net/d/fly-instance/fly-instance?viewPanel=69) panel, on the [Fly Instance](https://fly-metrics.net/d/fly-instance/fly-instance) dashboard in [Managed Grafana](/monitoring/metrics#managed-grafana):
