...
source_url: https://fly.io/docs/machines/guides-examples/machine-placement/
---
...
Most of the time this just works—`dfw` and `iad` are solid bets for region choices. But some regions, like `sjc` and `gru`, tend to be in high demand. If you hardcode your placement into one of those and cross your fingers, you might find yourself scaling to zero.
...
### Scale commands don't (yet) do this {#scale-commands-dont-yet-do-this}
...
Here's the [current list](/reference/regions): ams, arn, cdg, dfw, ewr, fra, gru, iad, jnb, lax, lhr, nrt, ord, sin, sjc, syd, yyz.
</Info>


### Related reading

- [An Introduction to Fly Machines](/machines/overview)
- [Regions Reference](/reference/regions)
- [Fly Machines API](/machines/api)
- [Get Regions](/api/machines/platform/get-regions)
