...
source_url: https://fly.io/docs/machines/guides-examples/machine-restart-policy/
---
...
## Check a Machine's restart policy {#check-a-machines-restart-policy}
...
## Change a Machine's restart policy with flyctl {#change-a-machines-restart-policy-with-flyctl}
...
## Change a Machine's restart policy with the Machines API {#change-a-machines-restart-policy-with-the-machines-api}
