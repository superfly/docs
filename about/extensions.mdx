...
source_url: https://fly.io/docs/about/extensions/
---

Fly.io is a global cloud service for running full stack apps close to users. We run on our own hardware in [datacenters all over the world](/reference/regions).
...
Services such as managed databases, exception handlers, CI runners or log aggregators are great examples. Check out our [managed Upstash for Redis](/upstash/redis) to get an idea of what's possible, and how we integrate services directly into our CLI.
...
Our [Extensions API documentation](/reference/extensions_api) outlines our API and SSO requirements in detail.
...
To fulfil our promise of a performant application in any Fly.io region, latency sensitive services — like Redis or MySQL — should be deployed on Fly.io. You'll also benefit from volume discounts on cloud resources and a growing number of [global points of presence](/reference/regions).
...
We also offer cost-cutting features such as [automatic VM stop/start based on incoming request volume](/launch/autostop-autostart). Contact us at [extensions@fly.io](mailto:extensions@fly.io) to learn more - we're happy to help you get started!
