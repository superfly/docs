...
import { RegionPricingSelector } from "/snippets/RegionPricingSelector.jsx"

  <img src="/images/pricing.png" alt="Illustration by Annie Ruygt of Frankie the hot air balloon demonstrating a pricing chart on a whiteboard" />
