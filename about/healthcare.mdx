...
source_url: https://fly.io/docs/about/healthcare/
---

  <img src="/images/healthcare.png" alt="Illustration by Annie Ruygt of Frankie the hot air balloon examining a green box with A written on it" />
...
Our blueprint for [Going to production with healthcare apps](/blueprints/going-to-production-with-healthcare-apps) runs a developer or operations engineer through the process of evaluating Fly.io’s security for HIPAA healthcare apps, launching a pilot application, signing a BAA, and deploying to production.
