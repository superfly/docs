...
source_url: https://fly.io/docs/networking/understanding-cloudflare/
---

  <img src="/images/understanding-cloudfare.png" alt="Illustration by Annie Ruygt of a big cloud with Fly balloons exiting from inside it" />
...
## CDN proxy setup ("orange cloud") {#cdn-proxy-setup-quot-orange-cloud-quot}
...
- [Custom domain guide](/networking/custom-domain)
- [Certificates API reference](/machines/api/certificates-resource)
- [flyctl certs commands](/flyctl/cmd/fly_certs)
- [fly certs import reference](/flyctl/cmd/fly_certs_import)
