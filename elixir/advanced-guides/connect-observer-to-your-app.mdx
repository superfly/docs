...
og:description: Guide for connecting a locally running Observer instance to your application running
  on Fly.
source_url: https://fly.io/docs/elixir/advanced-guides/connect-observer-to-your-app/
---
...
![Observer screen shot](/images/observer-tictac-local-application-pane.webp?card&2/3&centered)
...
![WireGuard observer connection](/images/elixir-wireguard-observer-tunnel.webp?2/3&centered)
...
See [this guide on creating a static cookie value](/elixir/the-basics/clustering#the-cookie-situation) in your Elixir project.

## WireGuard Tunnel

Setup WireGuard on your local machine. Follow the Fly.io [Private Network VPN](/networking/private-networking#private-network-vpn) guide to walk through that.
...
![Observer connected to local node](/images/observer-local-node.webp?centered)
...
![Observer connected to local node](/images/observer-local-node-menu.webp?2/3&centered)
...
![Observer connected to local node](/images/observer-local-node-connected.webp?centered)
