...
og:description: Guide shows interesting things we can do when Livebook connects to our deployed app
  running on Fly.
source_url: https://fly.io/docs/elixir/advanced-guides/interesting-things-with-livebook/
---
...
Once you have [Livebook connected to your app on Fly](/elixir/advanced-guides/connect-livebook-to-your-app), you are ready to start playing!
...
![Livebook runtime connection](/images/livebook-runtime-link.webp)
...
![Pie chart visualization](/images/livebook-personality-pie-visualization.webp?card&centered)
...
![Bar chart visualization](/images/livebook-personality-bar-visualization.webp?card&centered)
...
![VegaLite examples](/images/livebook-vegalite-examples.webp?card&2/3&centered)
