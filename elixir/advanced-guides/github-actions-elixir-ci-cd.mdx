...
og:description: Setup GitHub CI/CD for your Elixir project.
source_url: https://fly.io/docs/elixir/advanced-guides/github-actions-elixir-ci-cd/
---
...
[Continuous Deployment with Fly.io and GitHub Actions](/launch/continuous-deployment-with-github-actions)
