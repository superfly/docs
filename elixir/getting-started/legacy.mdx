...
og:description: Legacy Getting Started guide for Phoenix applications generated prior to v1.6.3.
source_url: https://fly.io/docs/elixir/getting-started/legacy/
---
...
launching newer Elixir apps](/elixir/getting-started).
...
Next, you'll be prompted to select a region to deploy in. The closest region to you is selected by default. You can use this or change to another region. You can find the [list of supported regions here](/reference/regions).
