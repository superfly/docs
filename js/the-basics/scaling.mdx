---
title: Scaling
og:description: Scaling your application to meet demand
source_url: https://fly.io/docs/js/the-basics/scaling/
---
...
For information on costs, see [Fly App Pricing](/about/pricing).
...
run [`fly machine update --vm-cpus`](/flyctl/cmd/fly_machine_update) to update the number of CPUs a single machine.
...
[Scale the Number of Machines](/launch/scale-count) page.
