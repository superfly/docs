---
title: Dependencies
og:description: Installing needed dependencies, and addressing common problems.
source_url: https://fly.io/docs/js/the-basics/dependencies/
---
...
[Run a Deno App](/js/frameworks/deno) for
more information.
