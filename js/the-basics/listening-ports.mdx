...
og:description: Connecting your application to the internet.
source_url: https://fly.io/docs/js/the-basics/listening-ports/
---
...
[`services` section](/reference/configuration#the-services-sections) for each additional port.  Be sure to review our
[Public Network Services](/networking/services) page before proceeding, in particular:

  * If you want your port other than 80/443 to be available on IPv4 you will need to [allocate a dedicated IPv4 address](/flyctl/cmd/fly_ips_allocate-v4).
