---
title: Prisma
source_url: https://fly.io/docs/js/prisma/
---
...
For most applications using one of these two databases, [fly launch](/reference/fly-launch) will pick a configuration that will get you up and running.  For more information, click on one of the following links:
